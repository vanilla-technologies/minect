...
//! contain commands generated by the Rust program. Listening for their output works by polling
...
impl MinecraftConnectionBuilder {
    ...
    ///
    /// This setting has no effect for [logged_cart_command](command::logged_cart_command)s. Logging
    /// still has to be enabled for these manually.
    ///
    /// Default: `true`.
