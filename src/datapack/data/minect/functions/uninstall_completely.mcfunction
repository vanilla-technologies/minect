...
tellraw @s [{"text":""},{"text":"[Info]","color":"blue","hoverEvent":{"action":"show_text","contents":"Minect"}},{"text":" Minect is now uninstalled from Minecraft, but there are still files on disk that we can't delete from within Minecraft. You can now safely delete the following directories in your world directory:\n - datapacks/minect\n - generated/minect\n Alternatively you can reinstall minect by executing "},{"text":"datapack enable \"file/minect\"","clickEvent":{"action":"run_command","value":"/datapack enable \"file/minect\""},"hoverEvent":{"action":"show_text","contents":"Click to execute"},"color":"aqua"}]
